...
export default {
  ...
  data() {
    return {
      datedef: [
        { 'date': '2020-10-19', 'content': 'General(08:00-12:00)', 'cid': 'qjl' },
        { 'date': '2020-10-20', 'content': 'AEST(13:30-18:00)', 'cid': '' },
        { 'date': '2020-10-29', 'content': 'ANZ(13:30-18:00)', 'cid': 'qjz' },
        { 'date': '2020-11-09', 'content': 'General(08:00-12:00)', 'cid': 'qjsb' },
        { 'date': '2020-11-20', 'content': 'qjl', 'cid': null }
      ],
      prop: 'date',
      dialogVisible: false,
      form: {
      ...
      const loop = data => {
        return (
          data.defvalue.value ? (<div><div>{data.defvalue.text}</div>
            <div style='color:red;'>{data.defvalue.value.cid}</div>
