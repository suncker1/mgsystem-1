...
export default {
  ...
  methods: {
    ...
    submitShift() {
      ...
      // axios({
      //   url: 'http://120.25.164.172:9124/system/shift/',
      //   method: 'post',
      //   // data: {
      //   //   activities: this.form.activities,
      //   //   end: this.changeNowFormatDate(this.form.valuedate[1]),
      //   //   endTime: this.getNowFormattime(this.form.value1[1]),
      //   //   engineer: this.form.engineer,
      //   //   shift: this.form.shift,
      //   //   start: this.changeNowFormatDate(this.form.valuedate[0]),
      //   //   startTime: this.getNowFormattime(this.form.value1[0]),
      //   //   task: this.form.task,
      //   //   type: this.form.type
      //   // },
      //   headers: {
      ...
      //   })
      // console.log(this.getNowFormattime(this.form.value1[0]))
